    ...
    async execute(interaction) {
        ...
        if (subcommand === 'role') {
            ...
            try {
                ...
                if (stats.seriesCount !== undefined) embed.addFields({ name: 'Total Series', value: stats.seriesCount.toString(), inline: true });
                if (stats.volumeCount !== undefined) embed.addFields({ name: 'Total Volumes', value: stats.volumeCount.toString(), inline: true });
                if (stats.chapterCount !== undefined) embed.addFields({ name: 'Total Chapters', value: stats.chapterCount.toString(), inline: true });
                if (stats.totalFiles !== undefined) embed.addFields({ name: 'Total Files', value: stats.totalFiles.toString(), inline: true });
                if (stats.totalSize !== undefined) embed.addFields({ name: 'Total Size', value: formatFileSize(stats.totalSize), inline: true });
                if (stats.totalGenres !== undefined) embed.addFields({ name: 'Total Genres', value: stats.totalGenres.toString(), inline: true });
                if (stats.totalTags !== undefined) embed.addFields({ name: 'Total Tags', value: stats.totalTags.toString(), inline: true });
                if (stats.totalPeople !== undefined) embed.addFields({ name: 'Total People', value: stats.totalPeople.toString(), inline: true });
                if (stats.totalReadingTime !== undefined) embed.addFields({ name: 'Total Reading Time', value: formatReadingTime(stats.totalReadingTime), inline: true });
